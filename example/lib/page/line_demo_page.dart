...
class _LineChartDemoPageState extends State<LineChartDemoPage> {
  ...
  @override
  void initState() {
    ImageAnnotation.getAssetImage('images/location.png', width: 15, height: 15)
        .then((value) {
      setState(() {
        logoImage = value;
      });
                ...
                SizedBox(
                  ...
                  child: ChartWidget(
                    ...
                    coordinateRender: ChartDimensionsCoordinateRender(
                      ...
                      //提示的文案信息
                      tooltipBuilder:
                          (BuildContext context, List<ChartLayoutParam> body) {
                        String text =
                  ...
                  child: ChartWidget(
                    ...
                    coordinateRender: ChartDimensionsCoordinateRender(
                      foregroundAnnotations: [
                        ...
                        LabelAnnotation(
                            positions: [6, 380], text: '380', scroll: false),
                      ],
